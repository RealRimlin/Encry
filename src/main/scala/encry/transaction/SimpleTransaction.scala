...
class SimpleTransaction extends BoxTransaction[PublicKey25519Proposition, PublicKey25519NoncedBox] {
  val fee: Long
  val timestamp: Long
}
...
case class SimplePayment(sender: PublicKey25519Proposition,
  ...
  override def serializer: Serializer[SimplePayment] = SimplePaymentCompanion
