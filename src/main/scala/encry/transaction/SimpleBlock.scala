...
import encry.transaction.SimpleBlock._
import encry.{BaseTarget, GenerationSignature}
...
case class SimpleBlock(override val parentId: BlockId,
  ...
  override def serializer = SimpleBlockCompanion
...
object SimpleBlock {
  val ModifierTypeId: ModifierTypeId = ModifierTypeId @@ 1.toByte
